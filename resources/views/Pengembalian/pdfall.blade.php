		...
		<body>
			...
			@foreach($pengembalian as $key)
			  <tr>
			    ...
			    <td class="tg-rv4w" width="5%">{{$key->id_pengembalian}}</td>
			    <td class="tg-rv4w" width="20%">{{$key->namapengembalian}}</td>
			    ...
			    <td class="tg-rv4w" width="20%"><b style="color:green;">{{$key->keterangan	}}</b></td>
			  </tr>
			 @endforeach
