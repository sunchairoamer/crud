	...
	<head>
		...
		<body>
			...
			<div style="font-family:Arial; font-size:12px;">
				<center><h2>LAPORAN PENGEMBALIAN BARANG</h2></center>	
			</div>
			<H4>Nama Pengembali : {{$pengembalian->namapeminjam}}</H4>
			<br>
			<table class="tg">
			  <tr>
			  ...
			  <tr>
			    ...
			    <td class="tg-rv4w" width="5%">{{$key->Pinjam->id_peminjam}}</td>
			    <td class="tg-rv4w" width="20%">{{$key->Pinjam->namapeminjam}}</td>
			    ...
			    <td class="tg-rv4w" width="20%"><b style="color:green;">{{$key->status}}</b></td>pengembalian
			  </tr>
				@endforeach
			</table>
		</body>
